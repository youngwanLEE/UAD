...
class COCOEvaluator(DatasetEvaluator):
    ...
    def _derive_coco_results(self, coco_eval, iou_type, class_names=None):
        ...
        metrics = {
            ...
            "bbox": ["AP", "AP50", "AP55", "AP60", "AP65", "AP70", "AP75", "AP80", "AP85", "AP90", "AP95", "APs", "APm", "APl",
                     "AR", "AR50", "AR55", "AR60", "AR65", "AR70", "AR75", "AR80", "AR85", "AR90", "AR95", "ARs", "ARm", "ARl"],
...
def instances_to_coco_json(instances, img_id):
    ...
    has_certainty = instances.has("certainty")
    if has_certainty:
        certainties = instances.certainty.tolist()
    ...
    for k in range(num_instance):
        result = {
            ...
            "bbox": boxes[k],
            "score": scores[k],
            # "score": scores[k] if not has_certainty else scores[k] * certainties[k]
        }
        if has_mask:
        ...
        if has_certainty:
            result["certainty"] = certainties[k]
...
def _evaluate_predictions_on_coco(coco_gt, coco_results, iou_type, kpt_oks_sigmas=None):
    ...
    # has_certainty = "certainty" in coco_results[0]
